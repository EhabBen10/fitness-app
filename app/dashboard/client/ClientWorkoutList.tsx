            ...
            <div className="space-y-4">
                {workouts.map((program) => (
                    <div
                        ...
                        className="border border-gray-200 dark:border-slate-700 rounded-lg p-4 bg-gray-50 dark:bg-slate-800 cursor-pointer transition hover:bg-gray-100 dark:hover:bg-slate-700"
                    ...
                    >
                        ...
                        {/* Expanded details */}
                        {expandedId === program.workoutProgramId && (
